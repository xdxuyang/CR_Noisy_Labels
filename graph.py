...
TOKENIZER = RobertaTokenizer.from_pretrained('/home/dell/.cache/huggingface/transformers/large/')
LM_MODEL = RobertaForMaskedLMwithLoss.from_pretrained('/home/dell/.cache/huggingface/transformers/large/')
