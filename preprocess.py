...
from convert_csqa import convert_to_entailment
from convert_obqa import convert_to_obqa_statement
from conceptnet import extract_english, construct_graph
from grounding import create_matcher_patterns, ground
...
def main():
    ...
    parser.add_argument('--run', default=['csqa'], choices=['common', 'csqa', 'obqa'], nargs='+')
